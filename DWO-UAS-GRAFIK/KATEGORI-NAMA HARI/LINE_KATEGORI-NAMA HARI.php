<?php
	...
	$kategori = $conn->query("SELECT CONCAT('name:',f.kategori) as name, CONCAT('y:', SUM(fp.amount)) as y, CONCAT('drilldown:', f.kategori) as drilldown 
		FROM film f 
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Nilai Penjualan (WH Sakila) - Semua Kategori'
    },
    subtitle: {
        text: 'Klik line untuk melihat detil nilai penjualan perkategori berdasarkan Nama Hari'
    },
   accessibility: {
		announceNewData: {
			enabled: true
